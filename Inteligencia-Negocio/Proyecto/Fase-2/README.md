...
Este repositorio contiene una solución completa y **100% reproducible** de **Business Intelligence (BI)**. Incluye la infraestructura contenerizada de la base de datos, el pipeline de datos automatizado y el reporte interactivo final listo para su análisis.
